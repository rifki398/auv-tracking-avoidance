function [detected_obs,r_obs,ang_obs,intersect,toward] = sonar3D(x,etadot,target,obs)

r_max = 60;            % Sonar range
alpha = deg2rad(30); % elevation
...
function discriminant = line_intersects_sphere(pos,target,obs,radius,tol)
d = target - pos;
f = pos - obs;
